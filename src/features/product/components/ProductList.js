                    ...
                    <div className="mx-auto max-w-2xl px-4 py-0 sm:px-6 sm:py-0 lg:max-w-7xl lg:px-8">
                      ...
                      <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                        {products.map((product) => (
                          ...
                          <div key={product.id} className="group relative border-solid border-2 border-gray-50">
                   
                              <img
                                alt={product.title}
                                src={product.thumbnail}
                                className="aspect-square w-full rounded-md bg-gray-200 object-cover group-hover:opacity-75 lg:aspect-auto lg:h-80"></img>
                            ...
                            <div className="mt-4 flex justify-between">
                              <div>
                                ...
                                <p className="mt-1 text-sm text-gray-500">
                                  <StarIcon className='w-3 h-5 inline'></StarIcon>{product.rating}</p>
                              </div>
                              <div>
